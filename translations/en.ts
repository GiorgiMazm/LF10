  ...
  en: {
    flatPage: {
      label: {
        ...
        taxNumber: "Tax code",
        firstPLastName: "Family name of 1. parent",
        firstPFirstName: "Given name of 1. parent",
        firstPBirth: "Birth date of 1. parent",
        firstPSex: "Sex of 1. parent",
        firstPNation: "Nationality of 1. parent",
      ...
      placeholder: {
        ...
        firstPLastName: "Smith",
        firstPFirstName: "James",
